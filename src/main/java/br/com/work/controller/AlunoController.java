...
public class AlunoController {
	...
	public ResponseEntity<List<Aluno>> buscarAlunoPorNome(@RequestParam(name = "nome") String nome) {
		List<Aluno> alunos = service.buscarAlunosPorNome(nome);
		if (alunos == null) {
			return ResponseEntity.notFound().build();
		}
	...
	public ResponseEntity<Aluno> atualizarAlunoPorId(@PathVariable Long alunoId, @RequestBody Aluno aluno) {
